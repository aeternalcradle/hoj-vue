export const m = {
  ...
  Latest_Problem: '最新题目',
  Supported_Remote_Online_Judge: '这是离别的馈赠',
  Statistics_Submissions_In_The_Last_Week: '最近一周提交统计（不存在于这个世界上的功能）',
  ...
  Scheduled: '筹备中',
  Ended: '已结束',
  No_contest: '暂无比赛，其实也不是暂无比赛啦，只是我们懒得写这个比赛',
  Contests: '比赛',
  Public: '公开赛',
  Private: '私有赛',
  Protected: '保护赛',
