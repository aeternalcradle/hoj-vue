        ...
        <div class="mundb-footer">
          <el-row>
            ...
            >
              ...
              <p class="mb-1">
                <a
                  href="https://www.bilibili.com/video/BV1FX4y1g7u8/?spm_id_from=333.337.search-card.all.click&vd_source=966820c2c8feca42e77acc069e5bc08f"
                  target="_blank"
                >{{
                  $t('m.Open_Source')
                }}</a>
...
export default {
  ...
  data() {
    return {
      isAdminView: false,
      showFooter: true,
      externalLink: "https://www.bilibili.com/video/BV1cr4y1F7kh/?spm_id_from=333.337.search-card.all.click&vd_source=966820c2c8feca42e77acc069e5bc08f"
