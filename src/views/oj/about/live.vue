<template>
  <div>
    ...
    <el-row>
      <el-col :span="8">
        <el-card :body-style="{ padding: '0px' }">
          <img src="http://localhost:6688/upload/kuizeng.png" class="image">
          <div style="padding: 14px;">
            ...
            <div class="bottom clearfix">
              ...
              <el-button type="text" class="button">哼哼哼哼哼哼啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊</el-button>
            </div>
          </div>
        </el-card>
      </el-col>
    ...
    <el-card class="box-card">
      ...
      <div class="text item">
        <p>你说得对，但是这就是软件工程，学费6500，保研率不到20%，一次大作业通宵十天的专业。
          要学数据结构，前后端开发，还有ics。每个暑假都有项目，甚至老师不会上课，全靠自学。
          大三暑假甚至找不到实习，还有毕业春招找不到工作。然后，年纪提升还能获得腰肌劳损，
          神经衰弱，缩短人的寿命，还缩短发量，然后还有颈椎病。女朋友就更不要。。。啊啊啊啊啊啊啊啊!!!
        </p>
      </div>
    </el-card>
  </div>
