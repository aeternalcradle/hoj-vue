...
import Live from "@/views/oj/about/live.vue";
    ...
    children: [
      {
        ...
        path: 'discuss',
        component: UserMsg,
        meta: {title: 'Discuss Message' }
      },
      {
        name: 'ReplyMsg',
        path: 'reply',
        component: UserMsg,
        meta: {title: 'Reply Message' }
      },
      {
        name: 'LikeMsg',
        path: 'like',
        component: UserMsg,
        meta: {title: 'Like Message' }
      },
      {
        name: 'SysMsg',
        path: 'sys',
        component: SysMsg,
        meta: {title: 'System Message' }
      },
      {
        name: 'MineMsg',
        path: 'mine',
        component: SysMsg,
        meta: {title: 'Mine Message' }
      },
    ]
  },
  {
